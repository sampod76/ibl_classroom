...
import { CheckCircle2, Clock, AlertCircle, Video, Users, FileText, Plus, BarChart3 } from "lucide-react"
import { Badge } from "@/components/ui/badge"
import { Avatar, AvatarFallback } from "@/components/ui/avatar"

export function ClassroomSidebar({ userRole = "student" }: { userRole?: "student" | "teacher" }) {
  return (
    <aside className="space-y-4">
      ...
      {userRole === "teacher" && (
        <Card className="p-4">
          ...
          <div className="mt-3 flex items-center justify-between rounded-lg bg-muted px-3 py-2">
            <code className="text-lg font-mono font-semibold text-foreground">abc123x</code>
            <Button variant="ghost" size="sm">
              Copy
            </Button>
          </div>
          <p className="mt-2 text-xs text-muted-foreground">Share this code with students to join the class</p>
        </Card>
      )}
      ...
      {userRole === "teacher" && (
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-foreground">Class Overview</h3>
        ...
        <div className="mt-4 space-y-3">
          <div className="flex gap-3 rounded-lg border border-destructive/20 bg-destructive/5 p-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-foreground">Midterm Exam</p>
          ...
          <div className="flex gap-3 rounded-lg border border-border p-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-foreground">Calculus Assignment</p>
        ...
        <Card className="p-4">
          ...
          <div className="mt-4 space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground">Submit Chapter 5 Assignment</p>
            ...
            <div className="flex items-start gap-3 opacity-60">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground line-through">Complete Week 6 Quiz</p>
            ...
            <div className="flex items-start gap-3 opacity-60">
              <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-accent" />
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground line-through">Review Lecture Notes</p>
                <p className="text-xs text-muted-foreground">Completed</p>
              </div>
            </div>
          </div>
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-semibold text-foreground">Class Members</h3>
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-center gap-3">
            <Avatar className="h-8 w-8">
              <AvatarFallback className="bg-primary text-xs text-primary-foreground">PJ</AvatarFallback>
            </Avatar>
            <div className="flex-1">
              <p className="text-sm font-medium text-foreground">Prof. Johnson</p>
          ...
          <div className="flex items-center gap-3">
            <Avatar className="h-8 w-8">
              <AvatarFallback className="bg-accent text-xs text-accent-foreground">JS</AvatarFallback>
            </Avatar>
            <div className="flex-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-foreground">Emily Martinez</p>
              <p className="text-xs text-muted-foreground">Student</p>
            </div>
          </div>
        </div>
